...
PYBIND11_MODULE(backend, m)
{
    ...
    m.def("gpuIsAvailable", &Environment::gpu_is_available, "Check if CUDA gpu is available");
    m.def("getGpuProperties", &Environment::get_gpu_properties, "Get properties of CUDA gpu");
